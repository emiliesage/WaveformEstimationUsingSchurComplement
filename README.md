...
$$
z = \begin{bmatrix} x \\\\ y \end{bmatrix} ~ \cal{N} \begin{pmatrix} \begin{bmatrix}\mu_x \\\\ \mu_y \end{bmatrix} & \begin{bmatrix} \Sigma_{xx} & \Sigma_{xy} \\\\ \Sigma_{yx} & \Sigma_{yy} \end{bmatrix} \end{cmatrix}
$$
